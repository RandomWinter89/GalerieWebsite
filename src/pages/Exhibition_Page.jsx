                    ...
                    <section className="flex flex-col gap-8 px-20 pt-32 pb-8">
                        ...
                        <article className="flex flex-col gap-8">
                            ...
                            <div className="w-full h-[42rem] grid grid-rows-2 grid-cols-2 gap-8">
                                <img className="row-span-2 h-full w-full bg-red-500"/>
                                <img className=" h-full w-full bg-slate-400"/>
                                <img className=" h-full w-full bg-slate-600"/>
                            </div>
                        </article>
                    </section>

                    <img className="my-8 w-full h-[26rem] bg-green-400"/>
